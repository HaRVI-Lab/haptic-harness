...
# verts1, faces1 = test_generator.polygonalPrismSlanted2(origin, width, height, r)
# verts1 = np.array(verts1)
# verts2, faces2 = test_generator.polygonalPrismSlanted(origin, width, height, r)
# verts2 = np.array(verts2)
#
# for i in range(len(verts1)):
#     if not (verts1[i] == verts2[i]).all():
...
for _ in range(test_length):
    ...
    #     prism1, time1 = test_generator.generateBase()
    #     times1.append(time1)
    #     prism2, time2 = test_generator.generateBase()
    #     times2.append(time2)
    # else:
    #     prism2, time2 = test_generator.generateBase()
    #     times2.append(time2)
    ...
    times1.append(time1)
    # if prism1 == prism2:
    #     print("polygonalPrismSlanted is good")
print(sum(times1) / test_length)
# print(sum(times2) / test_length)
